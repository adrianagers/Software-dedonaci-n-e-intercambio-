                ...
                <div class="row">
                    <div class="imagen2">
                        <div >
                            <section>
                                <div>
                                <center><img src="img/logos/MaripsaConLetraNegra.png" alt="" width="40%" ></center> 
                                </div>
                            </section>
                            <section>
                    ...
                    <div class="col-lg-6  p-5 " style=" background: linear-gradient(to right, #0c082ca9, #0c082ca9, #0c082ca9), url(../img/orange.jpg);">
                        ...
                        <!-- titulo principal -->
                        <section>
                            <h1 class="letraImagen">Registrate</h1>
                        </section>
                        <!-- formulario  -->
                        ...
                        @endif
                            <div class="flex items-center justify-end mt-4">
                                <a class="underline text-sm text-violet-600 hover:text-blueviolet-900" href="{{ route('login') }}">
